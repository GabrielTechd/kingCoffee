...
export default function SobreNos() {
  return (
    <main className="container text-black mx-auto px-4 py-8">
      <section className="mt-24 mb-12">
        <div>
          ...
          <p className="text-lg text-gray-800 leading-relaxed">
            ...
            <br /><br />
            Vivamus vitae sapien non sem vehicula varius. Maecenas congue placerat ex, et venenatis orci elementum vel. Fusce in nisl nec orci luctus mattis. Suspendisse vel neque vel turpis convallis tincidunt. Proin vel odio a
            Vivamus vitae sapien non sem vehicula varius. Maecenas congue placerat ex, et venenatis orci elementum vel. Fusce in nisl nec orci luctus mattis. Suspendisse vel neque vel turpis convallis tincidunt. Proin vel odio a
            Vivamus vitae sapien non sem vehicula varius. Maecenas congue placerat ex, et venenatis orci elementum vel. Fusce in nisl nec orci luctus mattis. Suspendisse vel neque vel turpis convallis tincidunt. Proin vel odio a
            Vivamus vitae sapien non sem vehicula varius. Maecenas congue placerat ex, et venenatis orci elementum vel. Fusce in nisl nec orci luctus mattis. Suspendisse vel neque vel turpis convallis tincidunt. Proin vel odio a
            Vivamus vitae sapien non sem vehicula varius. Maecenas congue placerat ex, et venenatis orci elementum vel. Fusce in nisl nec orci luctus mattis. Suspendisse vel neque vel turpis convallis tincidunt. Proin vel odio a
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-primary mb-4">Nossa Loja</h2>
        <p className="text-lg text-gray-800 leading-relaxed">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis turpis id ex sodales consectetur nec eu massa. Mauris quis ex vel metus facilisis bibendum.
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis turpis id ex sodales consectetur nec eu massa. Mauris quis ex vel metus facilisis bibendum.
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis turpis id ex sodales consectetur nec eu massa. Mauris quis ex vel metus facilisis bibendum.
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-primary mb-4">Nossa Colheita</h2>
        <p className="text-lg text-gray-800 leading-relaxed">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis turpis id ex sodales consectetur nec eu massa. Mauris quis ex vel metus facilisis bibendum.
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis turpis id ex sodales consectetur nec eu massa. Mauris quis ex vel metus facilisis bibendum.
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis turpis id ex sodales consectetur nec eu massa. Mauris quis ex vel metus facilisis bibendum.
      ...
      <section className="">
        <p className="text-lg text-gray-800 leading-relaxed">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat voluptatem atque vel nesciunt voluptas excepturi vitae laudantium porro? Odio doloribus error iure facilis ratione at hic, iste veritatis vero libero.
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat voluptatem atque vel nesciunt voluptas excepturi vitae laudantium porro? Odio doloribus error iure facilis ratione at hic, iste veritatis vero libero.
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat voluptatem atque vel nesciunt voluptas excepturi vitae laudantium porro? Odio doloribus error iure facilis ratione at hic, iste veritatis vero libero.
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat voluptatem atque vel nesciunt voluptas excepturi vitae laudantium porro? Odio doloribus error iure facilis ratione at hic, iste veritatis vero libero.
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat voluptatem atque vel nesciunt voluptas excepturi vitae laudantium porro? Odio doloribus error iure facilis ratione at hic, iste veritatis vero libero.
