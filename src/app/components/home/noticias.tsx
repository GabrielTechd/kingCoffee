            ...
            <div className="sm:ml-10 sm:mr-10 flex flex-col lg:flex-row">
                ...
                <div className=" ml-2 lg:w-1/2 lg:ml-10 lg:mt-0">
                    <div style={{ maxWidth: '1800px' }}>
                        ...
                        <div className="w-24 h-1 mb-2 bg-segundaria"></div>
                        ...
                        <a href="#" className="text-destaque hover:text-segundaria duration-700 inline-flex items-center">
                            Leia mais <IoIosArrowForward className="ml-1" />
                        </a>
                    </div>
                </div>
            </div>
            <div className="w-full h-1 my-5 md:my-10 bg-segundaria"></div>
